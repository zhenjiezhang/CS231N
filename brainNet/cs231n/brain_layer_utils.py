...
def conv_sbn_relu_pool_forward(x, w, b, gm, bt, conv_param, pool_param, sbn_param):
  """
  ...
  - w, b, conv_param: Weights and parameters for the convolutional layer
  - pool_param: Parameters for the pooling layer
  - gm, gamma for the spatial batch norm
  - bt, beta for the spatial batch norm
  - sbn_param, Parameters for the spatial batch norm
  ...
  """
  a, conv_cache = conv_forward_fast(x, w, b, conv_param)
  aa, sbn_cache = spatial_batchnorm_forward(a, gm, bt, sbn_param)
...
def conv_sbn_relu_pool_backward(dout, cache):
  ...
  ds = max_pool_backward_fast(dout, pool_cache)
  daa, dgm, dbt = spatial_batchnorm_backward(ds, sbn_cache)
  da = relu_backward(daa, relu_cache)
  dx, dw, db = conv_backward_fast(da, conv_cache)
  return dx, dw, db, dgm, dbt
